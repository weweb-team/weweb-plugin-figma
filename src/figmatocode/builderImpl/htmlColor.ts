...
export const htmlLinearGradient = (fill: GradientPaint) => {
  // Safety check for gradientHandlePositions
  if (!fill.gradientHandlePositions || fill.gradientHandlePositions.length < 2) {
    console.warn('Invalid gradientHandlePositions for linear gradient:', fill);
    return "";
  }
...
export const htmlRadialGradient = (fill: GradientPaint) => {
  ...
  if (!fill.gradientHandlePositions || fill.gradientHandlePositions.length < 3) {
    console.warn('Invalid gradientHandlePositions for radial gradient:', fill);
    return "";
  }
...
export const htmlAngularGradient = (fill: GradientPaint) => {
  // Safety check for gradientHandlePositions
  if (!fill.gradientHandlePositions || fill.gradientHandlePositions.length < 3) {
    console.warn('Invalid gradientHandlePositions for angular gradient:', fill);
    return "";
  }
...
export const htmlDiamondGradient = (fill: GradientPaint) => {
  // Safety check for gradientHandlePositions
  if (!fill.gradientHandlePositions || fill.gradientHandlePositions.length < 3) {
    console.warn('Invalid gradientHandlePositions for diamond gradient:', fill);
    return "";
  }
