...
export class HtmlTextBuilder extends HtmlDefaultBuilder {
  ...
  getTextSegments(node: TextNode): {
    ...
    return segments.map((segment, index) => {
      ...
      // Handle figma.mixed values safely
      const safeSegment = {
        fontSize: segment.fontSize !== figma.mixed ? segment.fontSize : 16,
        fontWeight: segment.fontWeight !== figma.mixed ? segment.fontWeight : 400,
        fontName: segment.fontName !== figma.mixed ? segment.fontName : { family: 'Arial', style: 'Regular' },
        textDecoration: segment.textDecoration !== figma.mixed ? segment.textDecoration : 'NONE',
        textCase: segment.textCase !== figma.mixed ? segment.textCase : 'ORIGINAL',
        lineHeight: segment.lineHeight !== figma.mixed ? segment.lineHeight : { unit: 'AUTO', value: 0 },
        letterSpacing: segment.letterSpacing !== figma.mixed ? segment.letterSpacing : { unit: 'PIXELS', value: 0 },
        fills: segment.fills !== figma.mixed ? segment.fills : []
      };

      const styleAttributes = formatMultipleJSX(
        {
          color: htmlColorFromFills(safeSegment.fills as any),
          "font-size": safeSegment.fontSize,
          "font-family": safeSegment.fontName.family,
          "font-style": this.getFontStyle(safeSegment.fontName.style),
          "font-weight": `${safeSegment.fontWeight}`,
          "text-decoration": this.textDecoration(safeSegment.textDecoration),
          "text-transform": this.textTransform(safeSegment.textCase),
          "line-height": this.lineHeight(safeSegment.lineHeight, safeSegment.fontSize),
          "letter-spacing": this.letterSpacing(
            safeSegment.letterSpacing,
            safeSegment.fontSize,
          ),
